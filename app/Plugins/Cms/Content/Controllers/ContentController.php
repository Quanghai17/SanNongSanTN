...
class ContentController extends RootFrontController
{
    ...
    private function _cms()
    {
        ...
        $filter_price = request('filter_price','','string');
        if($filter_price){
            switch($filter_price){
                case "5":
                    $sortPriceLeft = ['price','<',5000000];
                    break;
                case "5-10":
                    $sortPriceLeft = ['price','<',10000000];
                    $sortPriceRight = ['price','>',5000000];
                    break;
                case "10-15":
                    $sortPriceLeft = ['price','>',10000000];
                    $sortPriceRight = ['price','<',15000000];
                    break;
                case "15-20":
                    $sortPriceLeft = ['price','>',150000000];
                    $sortPriceRight = ['price','<',20000000];
                    break;
                case "20-30":
                    $sortPriceLeft = ['price','>',20000000];
                    $sortPriceRight = ['price','<',30000000];
                    break;
                case "30-50":
                    $sortPriceLeft = ['price','>',20000000];
                    $sortPriceRight = ['price','<',30000000];
