...
class FrontController extends RootFrontController
{
    public function vendorDetail($code = null) {
        ...
        // $stores = PluginModel::getStoreList();
        // dd($store);
        if(!$store) {
            return abort(404);
        }
        ...
        return view($this->templatePath . '.vendor.vendor_home',compact('store'),
            array(
    ...
    public function vendorList($code = null) {
        $stores = PluginModel::getStoreList();
        
        return view($this->templatePath . '.vendor.vendor_list', compact('stores'));
