                ...
                @else
                    <div class="col-12">
                        <h5><i class="fa fa-shopping-bag" aria-hidden="true"></i>
                            {{ sc_store('title', $storeCheckout) }}</h5>
                    </div>
                    {{-- Item cart detail --}}
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <form class="sc-shipping-address" id="form-process" role="form" method="POST"
                            action="{{ sc_route('checkout.process') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    @if (auth()->user())
                                        <div class="">
                                            <select class="form-control" name="address_process" style="width: 100%;"
                                                id="addressList">
                                                <option value="">{{ sc_language_render('cart.change_address') }}
                                                </option>
                                                @foreach ($addressList as $k => $address)
                                                    <option value="{{ $address->id }}"
                                                        {{ old('address_process') == $address->id ? 'selected' : '' }}>
                                                        -
                                                        {{ $address->first_name . ' ' . $address->last_name . ', ' . $address->address1 . ' ' . $address->address2 . ' ' . $address->address3 }}
                                                    </option>
                                                @endforeach
                                                <option value="new"
                                                    {{ old('address_process') == 'new' ? 'selected' : '' }}>
                                                    {{ sc_language_render('cart.add_new_address') }}</option>
                                            </select>
                                        </div>
                                    @endif
                                    {{-- // Select address if customer login --}}
                                    ...
                                    <table class="table table-borderless table-responsive">
                                        <tr width=100%>
                                            @if (sc_config('customer_lastname'))
                                                ...
                                                <td
                                                    ...
                                                    <input class="form-control" name="last_name" type="text"
                                                        placeholder="{{ sc_language_render('order.last_name') }}"
                                            ...
                                            @else
                                                <td colspan="2"
                                                    ...
                                                    <input class="form-control" name="first_name" type="text"
                                                        placeholder="{{ sc_language_render('order.name') }}"
                                                        value="{{ old('first_name', $shippingAddress['first_name']) }}">
                                                    @if ($errors->has('first_name'))
                                                        <span
                                                            class="help-block">{{ $errors->first('first_name') }}</span>
                                        ...
                                        @if (sc_config('customer_name_kana'))
                                            <tr>
                                                <td
                                                    class="form-group{{ $errors->has('first_name_kana') ? ' has-error' : '' }}">
                                                    <label for="phone" class="control-label"><i
                                                            class="fa fa-user"></i>
                                                    ...
                                                    @if ($errors->has('first_name_kana'))
                                                        <span
                                                            class="help-block">{{ $errors->first('first_name_kana') }}</span>
                                                    @endif
                                                </td>
                                                <td
                                                    class="form-group{{ $errors->has('last_name_kana') ? ' has-error' : '' }}">
                                                    <label for="phone" class="control-label"><i
                                                            class="fa fa-user"></i>
                                                        {{ sc_language_render('order.last_name_kana') }}:</label>
                                                    <input class="form-control" name="last_name_kana" type="text"
                                                        placeholder="{{ sc_language_render('order.last_name_kana') }}"
                                                        value="{{ old('last_name_kana', $shippingAddress['last_name_kana']) }}">
                                                    @if ($errors->has('last_name_kana'))
                                                        <span
                                                            class="help-block">{{ $errors->first('last_name_kana') }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endif
                                            ...
                                            @if (sc_config('customer_phone'))
                                                <td class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                    ...
                                                    <input class="form-control" name="email" type="text"
                                                        placeholder="{{ sc_language_render('order.email') }}"
                                                ...
                                                <td class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                                    ...
                                                    <input class="form-control" name="phone" type="text"
                                                        placeholder="{{ sc_language_render('order.phone') }}"
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    ...
                                                    <select class="form-control country " style="width: 100%;"
                                                        name="country">
                                                        <option value="">
                                                            __{{ sc_language_render('order.country') }}__</option>
                                            ...
                                            @if (sc_config('customer_postcode'))
                                                <td
                                                    ...
                                                    <input class="form-control" name="postcode" type="text"
                                                        placeholder="{{ sc_language_render('order.postcode') }}"
                                            ...
                                            @if (sc_config('customer_company'))
                                                <td
                                                    ...
                                                    <input class="form-control" name="company" type="text"
                                                        placeholder="{{ sc_language_render('order.company') }}"
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    ...
                                                    <input class="form-control" name="address1" type="text"
                                                        placeholder="{{ sc_language_render('order.address1') }}"
                                                        value="{{ old('address1', $shippingAddress['address1']) }}">
                                                    @if ($errors->has('address1'))
                                                        <span
                                                            class="help-block">{{ $errors->first('address1') }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endif
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    ...
                                                    <input class="form-control" name="address2" type="text"
                                                        placeholder="{{ sc_language_render('order.address2') }}"
                                                        value="{{ old('address2', $shippingAddress['address2']) }}">
                                                    @if ($errors->has('address2'))
                                                        <span
                                                            class="help-block">{{ $errors->first('address2') }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endif
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    ...
                                                    <input class="form-control" name="address3" type="text"
                                                        placeholder="{{ sc_language_render('order.address3') }}"
                                                        value="{{ old('address3', $shippingAddress['address3']) }}">
                                                    @if ($errors->has('address3'))
                                                        <span
                                                            class="help-block">{{ $errors->first('address3') }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endif
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div
                                                            ...
                                                            <h3 class="control-label"><i class="fa fa-truck"
                                                                    aria-hidden="true"></i>
                                                                {{ sc_language_render('order.shipping_method') }}:<br>
                                                            </h3>
                                                            @if ($errors->has('shippingMethod'))
                                                                <span
                                                                    class="help-block">{{ $errors->first('shippingMethod') }}</span>
                                                            @endif
                                                        </div>
                                        ...
                                        <div class="col-md-12 text-center">
                                            <div class="pull-right">
                                                ...
                                                <button class="button button-lg button-secondary" type="submit"
                                                    id="button-form-process">{{ sc_language_render('cart.checkout') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Button checkout --}}
