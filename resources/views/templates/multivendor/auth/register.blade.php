                ...
                <div class="col-xl-8 col-lg-10 col-md-12 m-auto">
                    <div class="row">
                        <div class="col-lg-6 col-md-8">
                            <h2 style="margin-bottom: 20px">{{ sc_language_render('customer.title_register') }}</h2>
                                ...
                                <div class="form_content" id="collapseExample">
                                    ...
                                    @if (sc_config('customer_name_kana'))
                                        ...
                                        <div class="form-group{{ $errors->has('last_name_kana') ? ' has-error' : '' }}">
                                            <input type="text"
                                                ...
                                                name="last_name_kana"
                                                placeholder="{{ sc_language_render('customer.last_name_kana') }}"
                                        ...
                                        <div class="form-group  {{ $errors->has('country') ? ' has-error' : '' }}">
                                            <select class="form-control country" style="width: 100%;" name="country">
                                                ...
                                                @foreach ($countries as $k => $v)
                                                    <option value="{{ $k }}"
                                                        {{ old('country') == $k ? 'selected' : '' }}>{{ $v }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        @foreach ($customFields as $keyField => $field)
                                            <div class="form-group{{ $errors->has('fields.' . $field->code) ? ' has-error' : '' }}">
                                                ...
                                                @if ($field->option == 'radio')
                                                    @if ($default)
                                                        ...
                                                        @foreach ($default as $key => $name)
                                                            <div>
                                                                <input type="radio" id="{{ $keyField . '__' . $key }}"
                                                                    name="fields[{{ $field->code }}]"
                                                                    value="{{ $key }}"
                                                                    {{ old('fields.' . $field->code) == $key ? 'checked' : '' }}>
                                                ...
                                                @elseif($field->option == 'select')
                                                    @if ($default)
                                                        <select class="form-control input-sm {{ $field->code }}"
                                                            style="width: 100%;" name="fields[{{ $field->code }}]">
                                                            <option value="">{{ sc_language_render($field->name) }}</option>
                                                            @foreach ($default as $key => $name)
                                                                <option value="{{ $key }}"
                                                                    {{ old('fields.' . $field->code) == $key ? 'selected' : '' }}>
                                                                    {{ $name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                @else
                                                    <input type="text"
                                                        ...
                                                        name="fields[{{ $field->code }}]"
                                                        placeholder="{{ sc_language_render($field->name) }}"
                                                ...
                                                @if ($errors->has('fields.' . $field->code))
                                                    <span class="help-block">
                                                        ...
                                                        {{ $errors->first('fields.' . $field->code) }}
                                                    </span>
                                                @endif
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                        <input type="password"
                                            ...
                                            name="password" placeholder="{{ sc_language_render('customer.password') }}"
                                            value="">
